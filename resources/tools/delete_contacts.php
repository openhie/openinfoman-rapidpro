<?php
$url = "http://localhost:8000/api/v2/contacts.json";
$ch = curl_init();
curl_setopt($ch, CURLOPT_HTTPHEADER, Array(
                                                   "Content-Type: application/json",
                                                   "Authorization: Token f69ee75ccad4c86f5470eddc048832ed48d20c7d",
                                                  ));
...
$url="http://localhost:8000/api/v2/contacts.json?uuid=$contact[uuid]";
